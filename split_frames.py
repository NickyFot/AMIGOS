...
def main(dir_path, dst_dir_path, class_name):
    ...
    for file_name in os.listdir(class_path):
        ...
        for idx in range(len(segments)):
            ...
            cmd = 'ffmpeg -vsync 0 -hwaccel cuvid -c:v h264_cuvid -accurate_seek -ss \"{}\" -t \"{}\" -i \"{}\" -vf hwdownload,format=nv12 -q:v 5 -f image2 \"{}/image_%05d.jpg\"'.format(segment_strt, segment_end, video_file_path, dst_directory_path)
            print(cmd)
