...
def main(dir_path, dst_dir_path, class_name):
    ...
    for file_name in os.listdir(class_path):
        ...
        for idx in range(len(segments)):
            ...
            cmd = 'ffmpeg -to {2} -i \"{0}\" -vf trim={1}:{2},setpts=PTS-STARTPTS -q:v 5 -f image2 \"{3}/image_%05d.jpg\"'.format(video_file_path, segment_strt, segment_end, dst_directory_path)
            print(cmd)
